...
class ShippingAddressPage extends Page {
  get getItemsNumber() {
    return $(`//*[@class="title"]/strong/span[1]`);
  }
  get btnExpandItems(){
    return $(`//*[@class="opc-block-summary"]/div`)
  }
  get listTitleName(){
    return $$(`//*[@class="product-item-name"]`)
  }
  get listQuantity(){
    return $$(`//*[@class="value"]`)
  }
  ...
  async clickExpandItems(){
    await this.click(await this.btnExpandItems)
  }
  async numberAllItems(){
    return await this.getItemsNumber.getText()
  }
  async clickNextBtn(){
